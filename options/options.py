...
class Options():
    ...
    def initialize(self):
        self.parser.add_argument('--sourceImg', required=False, help='path to source image')
        self.parser.add_argument('--targetImg', required=False, help='path to target image')
        ...
        self.parser.add_argument('--input_dir', type=str, default='../input_pics', help='the input-pics should be put here')
        self.parser.add_argument('--contiue_calc', action='store_true', help='if specified, continue calculation from last time.')
        self.parser.add_argument('--data_stored', action='store_true', help='if distance matrix calculated allready,dont prforme calculation at all.')
        self.parser.add_argument('--src_index', type=int, default=0, help='index of source image')
        self.parser.add_argument('--trg_index', type=int, default=0, help='index of target image')
